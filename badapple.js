    ...
    fileInput.addEventListener("change", function () {
        ...
        if (file.type.startsWith('video/')) {
            ...
            document.querySelectorAll("img").forEach(img => {
                ...
                newVideo.muted = true;           // 자동 재생을 위해 음소거는 필수입니다.
...
videoWallButton.addEventListener("click", () => {
    ...
    fileInput.addEventListener("change", function () {
        ...
        const video = document.createElement('video');
        video.src = URL.createObjectURL(file);
        video.muted = true; // 자동 재생 정책을 위해 음소거는 필수입니다.
        video.loop = true;
...
function setupVideoWall(video) {
    ...
    allImages.forEach(img => {
        ...
        const sourceWidth = (rect.width / totalWidth) * video.videoWidth;
        const sourceHeight = (rect.height / totalHeight) * video.videoHeight;
